...
const saveProfile = async () => {
  ...
  try {
    ...
    // 更新本地存储中的用户资料
    userStore.setNickname(userProfile.nickname)
    userStore.setGender(userProfile.gender)
    userStore.setGrade(userProfile.grade)
    userStore.setCollege(userProfile.college)
